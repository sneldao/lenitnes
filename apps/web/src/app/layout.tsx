...
export const metadata: Metadata = {
  ...
  description:
    'LENITNES watches software changes, commits scored judgments before outcomes are known, and evaluates code-market and scientific-integrity signals in separate public cohorts.',
  icons: {
