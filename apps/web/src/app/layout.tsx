        ...
        <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6">
          <header className="flex items-center justify-between border-b border-edge py-5">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="hidden text-xs text-slate-500 sm:inline">proof-chained monitoring</span>
            </Link>
            <nav className="flex items-center gap-4 text-sm">
              <Link href="/" className="text-slate-300 hover:text-accent">Dashboard</Link>
              <Link href="/rules" className="text-slate-300 hover:text-accent">Rules</Link>
