...
export const metadata = {
  title: 'Scientific software integrity — LENITNES',
  description:
    'LENITNES watches scientific software changes, preregisters integrity alerts, and grades them against the published record.',
};
    ...
    <div className="mx-auto max-w-4xl space-y-10 py-6 sm:py-10">
      <header className="space-y-4">
        ...
        <p className="max-w-2xl text-base leading-relaxed text-slate-400">
          LENITNES watches public scientific-software repositories, detects method and
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          >
            Science scorecard <ArrowRight className="h-3.5 w-3.5" />
          </Link>
          <Link
